...
var require_addBusinessDays = __commonJS((exports, module) => {
  ...
  function addBusinessDays(dirtyDate, dirtyAmount) {
    ...
    var sign3 = amount < 0 ? -1 : 1;
    var fullWeeks = (0, _index3.default)(amount / 5);
    date.setDate(date.getDate() + fullWeeks * 7);
    var restDays = Math.abs(amount % 5);
    while (restDays > 0) {
      date.setDate(date.getDate() + sign3);
      if (!(0, _index.default)(date))
        restDays -= 1;
    }
    if (startedOnWeekend && (0, _index.default)(date) && amount !== 0) {
      if ((0, _index6.default)(date))
        date.setDate(date.getDate() + (sign3 < 0 ? 2 : -1));
      if ((0, _index5.default)(date))
        date.setDate(date.getDate() + (sign3 < 0 ? 1 : -2));
    }
    date.setHours(hours);
    return date;
  }
...
var require_startOfISOWeekYear = __commonJS((exports, module) => {
  ...
  function startOfISOWeekYear(dirtyDate) {
    (0, _index3.default)(1, arguments);
    var year2 = (0, _index.default)(dirtyDate);
...
var require_differenceInBusinessDays = __commonJS((exports, module) => {
  ...
  function differenceInBusinessDays(dirtyDateLeft, dirtyDateRight) {
    ...
    var sign3 = calendarDifference < 0 ? -1 : 1;
    ...
    while (!(0, _index3.default)(dateLeft, dateRight)) {
      result += (0, _index5.default)(dateRight) ? 0 : sign3;
      dateRight = (0, _index.default)(dateRight, sign3);
    }
...
var require_differenceInDays = __commonJS((exports, module) => {
  ...
  function differenceInDays(dirtyDateLeft, dirtyDateRight) {
    ...
    var dateLeft = (0, _index.default)(dirtyDateLeft);
    var dateRight = (0, _index.default)(dirtyDateRight);
    var sign3 = compareLocalAsc(dateLeft, dateRight);
    var difference = Math.abs((0, _index2.default)(dateLeft, dateRight));
    dateLeft.setDate(dateLeft.getDate() - sign3 * difference);
    var isLastDayNotFull = Number(compareLocalAsc(dateLeft, dateRight) === -sign3);
    var result = sign3 * (difference - isLastDayNotFull);
    return result === 0 ? 0 : result;
  }
  module.exports = exports.default;
});
...
var require_differenceInISOWeekYears = __commonJS((exports, module) => {
  ...
  function differenceInISOWeekYears(dirtyDateLeft, dirtyDateRight) {
    ...
    var dateLeft = (0, _index.default)(dirtyDateLeft);
    var dateRight = (0, _index.default)(dirtyDateRight);
    var sign3 = (0, _index3.default)(dateLeft, dateRight);
    var difference = Math.abs((0, _index2.default)(dateLeft, dateRight));
    dateLeft = (0, _index4.default)(dateLeft, sign3 * difference);
    var isLastISOWeekYearNotFull = Number((0, _index3.default)(dateLeft, dateRight) === -sign3);
    var result = sign3 * (difference - isLastISOWeekYearNotFull);
    return result === 0 ? 0 : result;
  }
  module.exports = exports.default;
});
...
var require_differenceInMonths = __commonJS((exports, module) => {
  ...
  function differenceInMonths(dirtyDateLeft, dirtyDateRight) {
    ...
    if (difference < 1) {
      ...
      var isLastMonthNotFull = (0, _index3.default)(dateLeft, dateRight) === -sign3;
...
var require_differenceInYears = __commonJS((exports, module) => {
  ...
  function differenceInYears(dirtyDateLeft, dirtyDateRight) {
    ...
    var isLastYearNotFull = (0, _index3.default)(dateLeft, dateRight) === -sign3;
    var result = sign3 * (difference - Number(isLastYearNotFull));
    return result === 0 ? 0 : result;
  }
  module.exports = exports.default;
});
...
var require_endOfDecade = __commonJS((exports, module) => {
  ...
  function endOfDecade(dirtyDate) {
    ...
    var date = (0, _index.default)(dirtyDate);
    var year2 = date.getFullYear();
    var decade = 9 + Math.floor(year2 / 10) * 10;
...
var require_endOfWeek = __commonJS((exports, module) => {
  ...
  function endOfWeek(dirtyDate, options) {
    ...
    var date = (0, _index2.default)(dirtyDate);
    var day2 = date.getDay();
    var diff = (day2 < weekStartsOn ? -7 : 0) + 6 - (day2 - weekStartsOn);
    date.setDate(date.getDate() + diff);
    date.setHours(23, 59, 59, 999);
    return date;
  }
...
var require_endOfTomorrow = __commonJS((exports, module) => {
  ...
  function endOfTomorrow() {
    ...
    var date = new Date(0);
    date.setFullYear(year2, month, day2 + 1);
    date.setHours(23, 59, 59, 999);
    return date;
  }
  module.exports = exports.default;
...
var require_startOfUTCWeekYear = __commonJS((exports, module) => {
  ...
  function startOfUTCWeekYear(dirtyDate, options) {
    ...
    var defaultOptions = (0, _index5.getDefaultOptions)();
    var firstWeekContainsDate = (0, _index4.default)((_ref = (_ref2 = (_ref3 = (_options$firstWeekCon = options === null || options === undefined ? undefined : options.firstWeekContainsDate) !== null && _options$firstWeekCon !== undefined ? _options$firstWeekCon : options === null || options === undefined ? undefined : (_options$locale = options.locale) === null || _options$locale === undefined ? undefined : (_options$locale$optio = _options$locale.options) === null || _options$locale$optio === undefined ? undefined : _options$locale$optio.firstWeekContainsDate) !== null && _ref3 !== undefined ? _ref3 : defaultOptions.firstWeekContainsDate) !== null && _ref2 !== undefined ? _ref2 : (_defaultOptions$local = defaultOptions.locale) === null || _defaultOptions$local === undefined ? undefined : (_defaultOptions$local2 = _defaultOptions$local.options) === null || _defaultOptions$local2 === undefined ? undefined : _defaultOptions$local2.firstWeekContainsDate) !== null && _ref !== undefined ? _ref : 1);
    var year2 = (0, _index.default)(dirtyDate, options);
...
var require_lightFormatters = __commonJS((exports, module) => {
  ...
  var formatters = {
    y: function y(date, token) {
      ...
      return (0, _index.default)(token === "yy" ? year2 % 100 : year2, token.length);
    },
...
var require_formatters = __commonJS((exports, module) => {
  ...
  var formatters = {
    ...
    u: function u(date, token) {
      var year2 = date.getUTCFullYear();
      return (0, _index6.default)(year2, token.length);
    },
    ...
    w: function w(date, token, localize, options) {
      var week2 = (0, _index4.default)(date, options);
      if (token === "wo") {
  ...
  function formatTimezoneShort(offset, dirtyDelimiter) {
    ...
    return sign3 + String(hours) + delimiter + (0, _index6.default)(minutes, 2);
  }
  function formatTimezoneWithOptionalMinutes(offset, dirtyDelimiter) {
    if (offset % 60 === 0) {
      var sign3 = offset > 0 ? "-" : "+";
      return sign3 + (0, _index6.default)(Math.abs(offset) / 60, 2);
    }
...
var require_formatISO = __commonJS((exports, module) => {
  ...
  function formatISO(date, options) {
    ...
    if (representation !== "time") {
      var day2 = (0, _index2.default)(originalDate.getDate(), 2);
      var month = (0, _index2.default)(originalDate.getMonth() + 1, 2);
      var year2 = (0, _index2.default)(originalDate.getFullYear(), 4);
      result = "".concat(year2).concat(dateDelimiter).concat(month).concat(dateDelimiter).concat(day2);
    }
    if (representation !== "date") {
      ...
      if (offset !== 0) {
        ...
        var sign3 = offset < 0 ? "+" : "-";
        tzOffset = "".concat(sign3).concat(hourOffset, ":").concat(minuteOffset);
      } else {
        tzOffset = "Z";
      }
      var hour2 = (0, _index2.default)(originalDate.getHours(), 2);
      var minute2 = (0, _index2.default)(originalDate.getMinutes(), 2);
      var second = (0, _index2.default)(originalDate.getSeconds(), 2);
      var separator = result === "" ? "" : "T";
      var time = [hour2, minute2, second].join(timeDelimiter);
...
var require_formatISO9075 = __commonJS((exports, module) => {
  ...
  function formatISO9075(dirtyDate, options) {
    ...
    var timeDelimiter = format === "extended" ? ":" : "";
    if (representation !== "time") {
      var day2 = (0, _index3.default)(originalDate.getDate(), 2);
      var month = (0, _index3.default)(originalDate.getMonth() + 1, 2);
      var year2 = (0, _index3.default)(originalDate.getFullYear(), 4);
      result = "".concat(year2).concat(dateDelimiter).concat(month).concat(dateDelimiter).concat(day2);
    }
    if (representation !== "date") {
      var hour2 = (0, _index3.default)(originalDate.getHours(), 2);
      var minute2 = (0, _index3.default)(originalDate.getMinutes(), 2);
      var second = (0, _index3.default)(originalDate.getSeconds(), 2);
      var separator = result === "" ? "" : " ";
      result = "".concat(result).concat(separator).concat(hour2).concat(timeDelimiter).concat(minute2).concat(timeDelimiter).concat(second);
    }
    return result;
  }
  module.exports = exports.default;
...
var require_formatRFC3339 = __commonJS((exports, module) => {
  ...
  function formatRFC3339(dirtyDate, options) {
    ...
    var day2 = (0, _index3.default)(originalDate.getDate(), 2);
    var month = (0, _index3.default)(originalDate.getMonth() + 1, 2);
    var year2 = originalDate.getFullYear();
    var hour2 = (0, _index3.default)(originalDate.getHours(), 2);
    var minute2 = (0, _index3.default)(originalDate.getMinutes(), 2);
    var second = (0, _index3.default)(originalDate.getSeconds(), 2);
    ...
    if (tzOffset !== 0) {
      ...
      var sign3 = tzOffset < 0 ? "+" : "-";
      offset = "".concat(sign3).concat(hourOffset, ":").concat(minuteOffset);
    } else {
      offset = "Z";
    }
    return "".concat(year2, "-").concat(month, "-").concat(day2, "T").concat(hour2, ":").concat(minute2, ":").concat(second).concat(fractionalSecond).concat(offset);
  }
  module.exports = exports.default;
});
...
var require_formatRFC7231 = __commonJS((exports, module) => {
  ...
  function formatRFC7231(dirtyDate) {
    ...
    var year2 = originalDate.getUTCFullYear();
    var hour2 = (0, _index3.default)(originalDate.getUTCHours(), 2);
    var minute2 = (0, _index3.default)(originalDate.getUTCMinutes(), 2);
    var second = (0, _index3.default)(originalDate.getUTCSeconds(), 2);
    return "".concat(dayName, ", ").concat(dayOfMonth, " ").concat(monthName, " ").concat(year2, " ").concat(hour2, ":").concat(minute2, ":").concat(second, " GMT");
  }
  module.exports = exports.default;
});
...
var require_getDecade = __commonJS((exports, module) => {
  ...
  function getDecade(dirtyDate) {
    ...
    var date = (0, _index.default)(dirtyDate);
    var year2 = date.getFullYear();
    var decade = Math.floor(year2 / 10) * 10;
    return decade;
  }
  module.exports = exports.default;
});
...
var require_isExists = __commonJS((exports, module) => {
  ...
  function isExists(year2, month, day2) {
    if (arguments.length < 3) {
      throw new TypeError("3 argument required, but only " + arguments.length + " present");
    }
    var date = new Date(year2, month, day2);
    return date.getFullYear() === year2 && date.getMonth() === month && date.getDate() === day2;
  }
  module.exports = exports.default;
});
...
var require_utils2 = __commonJS((exports) => {
  ...
  function parseTimezonePattern(pattern, dateString) {
    ...
    return {
      value: sign3 * (hours * _index.millisecondsInHour + minutes * _index.millisecondsInMinute + seconds * _index.millisecondsInSecond),
      rest: dateString.slice(matchResult[0].length)
    };
  }
...
var require_YearParser = __commonJS((exports) => {
  ...
  var YearParser = /* @__PURE__ */ function(_Parser) {
    ...
    (0, _createClass2.default)(YearParser2, [{
      key: "parse",
      value: function parse(dateString, token, match) {
        var valueCallback = function valueCallback(year2) {
          return {
            year: year2,
...
var require_setUTCWeek = __commonJS((exports, module) => {
  ...
  function setUTCWeek(dirtyDate, dirtyWeek, options) {
    (0, _index4.default)(2, arguments);
    var date = (0, _index2.default)(dirtyDate);
    var week2 = (0, _index.default)(dirtyWeek);
    var diff = (0, _index3.default)(date, options) - week2;
  ...
  var DateParser = /* @__PURE__ */ function(_Parser) {
    ...
    (0, _createClass2.default)(DateParser2, [{
      ...
      value: function validate(date, value) {
        var year2 = date.getUTCFullYear();
        var isLeapYear = (0, _utils.isLeapYearIndex)(year2);
        var month = date.getUTCMonth();
        if (isLeapYear) {
...
var require_setUTCDay = __commonJS((exports, module) => {
  ...
  function setUTCDay(dirtyDate, dirtyDay, options) {
    ...
    var date = (0, _index.default)(dirtyDate);
    var day2 = (0, _index3.default)(dirtyDay);
...
var require_lastDayOfISOWeekYear = __commonJS((exports, module) => {
  ...
  function lastDayOfISOWeekYear(dirtyDate) {
    ...
    var year2 = (0, _index.default)(dirtyDate);
    var fourthOfJanuary = new Date(0);
    fourthOfJanuary.setFullYear(year2 + 1, 0, 4);
    fourthOfJanuary.setHours(0, 0, 0, 0);
    var date = (0, _index2.default)(fourthOfJanuary);
...
var require_nextDay = __commonJS((exports, module) => {
  ...
  var _index3 = _interopRequireDefault(require_requiredArgs());
  function nextDay(date, day2) {
    (0, _index3.default)(2, arguments);
    var delta = day2 - (0, _index2.default)(date);
    if (delta <= 0)
      delta += 7;
...
var require_parseISO = __commonJS((exports, module) => {
  ...
  function parseDate(dateString, year2) {
    ...
    if (isWeekDate) {
      if (!validateWeekDate(year2, week2, dayOfWeek)) {
        return new Date(NaN);
      }
      return dayOfISOWeekYear(year2, week2, dayOfWeek);
    } else {
      var date = new Date(0);
      if (!validateDate(year2, month, day2) || !validateDayOfYearDate(year2, dayOfYear)) {
        return new Date(NaN);
      }
      date.setUTCFullYear(year2, month, Math.max(dayOfYear, day2));
      return date;
    }
  }
  ...
  function parseTimezone(timezoneString) {
    ...
    if (!captures)
      return 0;
    var sign3 = captures[1] === "+" ? -1 : 1;
    var hours = parseInt(captures[2]);
    var minutes = captures[3] && parseInt(captures[3]) || 0;
    if (!validateTimezone(hours, minutes)) {
      return NaN;
    }
    return sign3 * (hours * _index.millisecondsInHour + minutes * _index.millisecondsInMinute);
  }
  function dayOfISOWeekYear(isoWeekYear, week2, day2) {
    var date = new Date(0);
    date.setUTCFullYear(isoWeekYear, 0, 4);
    var fourthOfJanuaryDay = date.getUTCDay() || 7;
    var diff = (week2 - 1) * 7 + day2 + 1 - fourthOfJanuaryDay;
    date.setUTCDate(date.getUTCDate() + diff);
    return date;
  }
  ...
  function validateDate(year2, month, date) {
    return month >= 0 && month <= 11 && date >= 1 && date <= (daysInMonths[month] || (isLeapYearIndex(year2) ? 29 : 28));
  }
...
var require_previousDay = __commonJS((exports, module) => {
  ...
  function previousDay(date, day2) {
    (0, _index.default)(2, arguments);
    var delta = (0, _index2.default)(date) - day2;
    if (delta <= 0)
      delta += 7;
...
var require_setMonth = __commonJS((exports, module) => {
  ...
  function setMonth(dirtyDate, dirtyMonth) {
    ...
    dateWithDesiredMonth.setFullYear(year2, month, 15);
    dateWithDesiredMonth.setHours(0, 0, 0, 0);
    var daysInMonth = (0, _index3.default)(dateWithDesiredMonth);
    date.setMonth(month, Math.min(day2, daysInMonth));
    return date;
  }
  module.exports = exports.default;
});
...
var require_setDay = __commonJS((exports, module) => {
  ...
  function setDay(dirtyDate, dirtyDay, options) {
    ...
    var diff = day2 < 0 || day2 > 6 ? day2 - (currentDay + delta) % 7 : (dayIndex + delta) % 7 - (currentDay + delta) % 7;
...
var require_setISODay = __commonJS((exports, module) => {
  ...
  function setISODay(dirtyDate, dirtyDay) {
    (0, _index5.default)(2, arguments);
    var date = (0, _index2.default)(dirtyDate);
    var day2 = (0, _index.default)(dirtyDay);
    var currentDay = (0, _index4.default)(date);
    var diff = day2 - currentDay;
...
var require_setWeek = __commonJS((exports, module) => {
  ...
  function setWeek(dirtyDate, dirtyWeek, options) {
    (0, _index3.default)(2, arguments);
    var date = (0, _index2.default)(dirtyDate);
    var week2 = (0, _index4.default)(dirtyWeek);
    var diff = (0, _index.default)(date, options) - week2;
    date.setDate(date.getDate() - diff * 7);
    return date;
  }
  module.exports = exports.default;
...
var require_setYear = __commonJS((exports, module) => {
  ...
  function setYear(dirtyDate, dirtyYear) {
    (0, _index3.default)(2, arguments);
    var date = (0, _index2.default)(dirtyDate);
    var year2 = (0, _index.default)(dirtyYear);
    if (isNaN(date.getTime())) {
      return new Date(NaN);
    }
...
var validateIssueKey = (method, issueKey) => {
  if (method.toLowerCase() === "PUT" && !issueKey) {
    throw new Error("issueKey es requerido para editar un ticket");
  }
  return issueKey;
};
var _isEdit = (method) => method == "PUT";
var requestTicketsJira = async (payload) => {
  const { method, key: issueKey, status } = payload;
  if (!method)
    return;
  const jiraRoute = _isEdit(method) ? `/rest/api/3/issue/${validateIssueKey(method, issueKey)}` : `/rest/api/3/issue`;
...
async function getExistingIssues(query, fields) {
  const response = await fetchFromJira({
    token: "token",
    apiBaseUrl: "appBaseUrl",
...
async function fetchFromJira({ token, apiBaseUrl, path, method, body }) {
  ...
  return await import_node_fetch.default(`${apiBaseUrl}/rest/api${path}`, {
    headers,
    method,
    body: method == "POST" ? JSON.stringify(body) : undefined
  });
}
async function transitionIssue(payload) {
...
((CsvRowHeaders2) => {
  ...
  CsvRowHeaders2["uuid"] = "Número de documento";
  ...
  CsvRowHeaders2["fechaDeRecepcion"] = "Fecha de recepción";
  CsvRowHeaders2["asignacionSapSku"] = "Asignación de SAP SKU";
  CsvRowHeaders2["estadoDeConciliacion"] = "Estado de conciliación";
  CsvRowHeaders2["estadoDeLasSolicitudes"] = "Estado de las solicitudes";
  CsvRowHeaders2["ordenDeCompra"] = "Orden de compra";
  CsvRowHeaders2["fechaDeEmision"] = "Fecha de emisión";
  CsvRowHeaders2["numeroDeEnvio"] = "Número de envío";
  CsvRowHeaders2["estadoDeEnvio"] = "Estado de envío";
...
function parseAndFormatDate(dateString, inputFormat = "dd-MM-yyyy", outputFormat = "yyyy-MM-dd") {
  ...
  return import_date_fns.format(parsedDate, outputFormat);
}
